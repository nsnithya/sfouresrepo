...
class LoadConfig:
    ...
    def __init__(self) -> None:
        ...
        self.index_dir: str = app_config["index_dir"]
        ...
        # basic_rag_read
        self.basic_rag_index_read_dir: str = app_config["llama_index_cfg"]["basic_rag"]["index_read_dir"]
        # pagewise_rag_save
        self.pagewise_rag_index_save_dir: str = app_config[
            "llama_index_cfg"]["pagewise_rag"]["index_save_dir"]
        # pagewise_rag_read
        self.pagewise_rag_index_read_dir: str = app_config[
            "llama_index_cfg"]["pagewise_rag"]["index_read_dir"]
        # sentence_retrieval_save
        self.sentence_index_save_dir: str = app_config[
            "llama_index_cfg"]["sentence_retrieval"]["index_save_dir"]
        # sentence_retrieval_read
        self.sentence_index_read_dir: str = app_config[
            "llama_index_cfg"]["sentence_retrieval"]["index_read_dir"]
